...
from kaggle.mask_to_submission import generate_submission_csv

SUBMISSION_PATH, CHECKPOINT_PATH = '../submissions/', '../checkpoints/'
TRAIN_IMAGE_PATH, TRAIN_LABEL_PATH = '../data/train/images/', '../data/train/groundtruth/'
TEST_IMAGE_PATH, TEST_LABEL_PATH = '../data/test/images/', '../data/test/predictions/'
TRAINING_SIZE, TESTING_SIZE = 100, 50
BATCH_SIZE, NUM_EPOCHS = 128, 70
